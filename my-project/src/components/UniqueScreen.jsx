...
const UniqueScreen = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between px-6 lg:px-20 py-10 bg-white space-y-8 lg:space-y-0">
      {/* Left Section */}
      <div className="lg:w-1/2 text-center lg:text-left">
        <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold font-michroma leading-tight text-black">
        ...
        <button className="mt-6 px-6 py-3 bg-black text-white text-base sm:text-lg font-semibold rounded-md transition-transform hover:scale-105">
      ...
      <div className="lg:w-1/2 flex justify-center">
        <img
          ...
          alt="Beverage Shelf"
          className="rounded-lg shadow-lg w-full max-w-sm sm:max-w-md object-cover max-h-[300px] sm:max-h-[400px] lg:max-h-[500px]"
        />
      </div>
    </div>
  );
